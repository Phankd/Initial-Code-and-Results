...
setwd("/Users/kevinphan/Desktop/Capstone")
...
#***** I see that a logistic regression with the features from the info gain with 15/30 folds for the test set is most optimal as it gives me highest AUC. *****
```
...
smp_size <- floor(0.75 * nrow(SVMData))
